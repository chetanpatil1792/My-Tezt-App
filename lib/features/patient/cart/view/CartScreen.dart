      ...
      child: Column(
        ...
        children: [
          ...
          Align(
            ...
            child: Text("Sample Collection Type",
            ...
            children: [
              Expanded(
                child: RadioListTile<String>(
                  ...
                  title: const Text("Visit Lab", style: TextStyle(fontSize: 12)),
                  subtitle: const Text("Give sample at lab", style: TextStyle(fontSize: 10)),
                  value: "LabVisit",
                  groupValue: controller.sampleCollectionType.value,
                  onChanged: (val) => controller.sampleCollectionType.value = val!,
                ),
              ),
              Expanded(
                child: RadioListTile<String>(
                  ...
                  subtitle: const Text("Phlebotomist visit", style: TextStyle(fontSize: 10)),
