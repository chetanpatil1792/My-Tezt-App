...
//   final dynamic orderData; // Received from CartController API call
//   final controller = Get.put(PaymentController());
//
//   PaymentPage({super.key, required this.totalAmount, this.orderData});
//
//   @override
...
class PaymentPage extends StatelessWidget {
  final double totalAmount;
  final dynamic orderData; // Received from CartController
  final controller = Get.put(PaymentController());
  ...
  // ... (Keep _buildCompactTotalCard and _buildMethodTile same as your original)
  Widget _buildCompactTotalCard() {
    return Container(
      margin: const EdgeInsets.all(16),
      padding: const EdgeInsets.all(20),
  ...
  Widget _buildPayNowButton() {
    return Container(
      ...
      child: Obx(() => ElevatedButton(
        // Pass totalAmount AND orderData to the controller
        onPressed: () => controller.startPayment(totalAmount, orderData),
        style: ElevatedButton.styleFrom(
          backgroundColor: const Color(0xFF3B82F6),
          padding: const EdgeInsets.symmetric(vertical: 16),
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
