...
//           if (selectedItemIds.contains(test['labTestId'])) {
...
//           var pId = package['labTestId'] ?? package['labPackageMasterId'];
//           if (pId != null && selectedItemIds.contains(pId)) {
...
//           String apiDate = item['bookingDate'] ?? ""; // "2026-03-07T00:00:00"
//           String apiFrom = item['slotFrom'] ?? "";    // "18:39:00"
//           String apiTo = item['slotTo'] ?? "";        // "18:40:00"
//
...
//             } else {
//               lab['packages'].removeWhere((p) => (p['labTestId'] ?? p['labPackageMasterId']) == itemId);
//             }
//           }
//         }
